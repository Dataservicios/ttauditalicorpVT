 ...
 */
public class EntregoPromocion extends Activity {
    private Activity MyActivity = this ;
    private static final String LOG_TAG = EntregoPromocion.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.entrego_promocion);
       ...
       // tv_Pregunta.setText("¿Se entregó promoción?");
    ...
    class loadPoll extends AsyncTask<PollDetail, Integer , Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result){
                ...
                intent = new Intent(MyActivity, ComunicoBeneficios.class);
